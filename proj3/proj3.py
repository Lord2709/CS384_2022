...
try:    
    if bool(re.search('[.]', constant_fk2d)):
        ...
        constant_fk2d = list(map(int,constant_fk2d.split()))[0]  
except:
    print("Re-Enter Constant Fk2d value")
...
try:
    if bool(re.search('[.]', multiplying_factor_3d)):
        ...
        multiplying_factor_3d = list(map(int,multiplying_factor_3d.split()))[0]
except:
    print("Re-Enter Multiplying Factor")
...
try:
    if bool(re.search('[.]', Shear_velocity)):
        ...
        Shear_velocity = list(map(int,Shear_velocity.split()))[0]
except:
    print("Re-Enter Shear Velocity")
...
if tch == 1:
    ...
    elif bool(re.search('[.]', Lambda)):
        Lambda = float(Lambda)
        count += 1
    else:
        if len(list(map(int,Lambda.split()))) == 0:
            pass
        else:
            Lambda = list(map(int,Lambda.split()))[0]
            count += 1
    ...
    elif bool(re.search('[.]', k)):
        k = float(k)
        count += 1
    else:
        if len(list(map(int,k.split()))) == 0:
            pass
        else:
            k = list(map(int,k.split()))[0]
            count += 1
